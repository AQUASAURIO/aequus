...
export function LoginView() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
            ...
            >
                <Card className="border-white/10 bg-zinc-900/90 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-aequo-gold opacity-50" />
                    <CardHeader className="space-y-1 flex flex-col items-center">
                        <div className="mb-4 p-4 rounded-3xl bg-zinc-950 border border-white/10 shadow-2xl ring-1 ring-white/5">
                            <Image
                                src="/favicon.png"
                                alt="Æquo Logo"
                                width={56}
